...
namespace Assesment
{
    class StudentMethod
    {
        ...
        public Student[] AddStudent(Student[] arr)
        {
        ...
        public void ShowDetails(Student[] arr)
        {
        ...
        public Student SpecificDetails(Student[] arr)
        {
        ...
        public void DisplaySpecificDetails(Student item)
        {
            Console.WriteLine($"Id:{item.Id}\nName:{item.Name}\nAddress:{item.Address}\n" +
                    $"Obtained Marks:{item.ObtainedMarks}\nTotal Marks:{item.TotalMarks}");
        ...
        public void UpdateDetails(Student[] arr)
        {
        ...
        public Student[] DeleteDetails(Student[] arr)
        {
